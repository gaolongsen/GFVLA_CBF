"""
ROS2 launch file for VLA letter building demonstration.

This launch file starts both the bridge and the VLA letter builder nodes.
"""
...
def generate_launch_description():
    """Generate launch description for VLA letter building demo."""
    ...
    # VLA letter builder node
    vla_builder_node = Node(
        package='dualarmvla_hardware',
        executable='demo_vla_letters_ros2',
        name='vla_letter_builder',
        output='screen',
    )
